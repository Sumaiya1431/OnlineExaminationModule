...
router.post('/', function (req, res, next) {
    ...
    //mine 
        ...
        //Question.findRandom().limit(global.count).exec(function (err, results) {
...
function uploadFile(source){
  var model = mongoXlsx.buildDynamicModel(Question);
    ...
    {
      mongoData[i].qb_dept_id = global.id; //add foreign key to be added here.
      //console.log('Mongo data:', mongoData[i].ques_id); 
    }
		Question.create(mongoData,(err)=>
    {
        if(!err);
